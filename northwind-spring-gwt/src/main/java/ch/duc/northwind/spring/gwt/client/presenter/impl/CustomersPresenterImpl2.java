...
public class CustomersPresenterImpl2 extends BasicPresenterImpl implements CustomersPresenter {
	
	private CustomersView view;
	private CustomerServiceAsync customerService;
	
	public CustomersPresenterImpl2(ClientFactory clientFactory) {
		super(clientFactory);
		customerService = clientFactory.getCustomersService();
		view = clientFactory.getCustomersView2();
